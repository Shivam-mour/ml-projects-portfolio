...
- **Reduce financial breakage and manual workload**
""")
...
""")
    ...
    with st.form("invoice_flag_form"):
        ...
        submit_flag = st.form_submit_button("🔍 Predict Approval Flag")
        ...
        if submit_flag:
            ...
            flag_prediction = predict_invoice_flag(input_data)['Prediction_Flag']
